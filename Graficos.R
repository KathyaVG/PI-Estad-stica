...
dim(penguins)
#La matriz penguins tiene 8 variables y 344 individuos (observaciones)
...
# 1.- Convertir las variables categóricas (cualitativas) a factores
...
penguins1<-penguins[,1:8]

#Dejamos toda la matriz importada con 8 columnas,de la 1 a la 8
#porque desde el inicio ya habíamos eliminado la columna de ID
